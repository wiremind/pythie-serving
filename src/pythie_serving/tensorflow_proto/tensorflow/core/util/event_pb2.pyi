...
class Event(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        file_version: typing.Text = ...,
        graph_def: builtins.bytes = ...,
        summary: typing.Optional[tensorflow.core.framework.summary_pb2.Summary] = ...,
        log_message: typing.Optional[global___LogMessage] = ...,
        session_log: typing.Optional[global___SessionLog] = ...,
        tagged_run_metadata: typing.Optional[global___TaggedRunMetadata] = ...,
        meta_graph_def: builtins.bytes = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["what",b"what"]) -> typing.Optional[typing_extensions.Literal["file_version","graph_def","summary","log_message","session_log","tagged_run_metadata","meta_graph_def"]]: ...
...
class WorkerHeartbeatRequest(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        shutdown_mode: global___WorkerShutdownMode.ValueType = ...,
        watchdog_config: typing.Optional[global___WatchdogConfig] = ...,
        exit_code: typing.Optional[global___RequestedExitCode] = ...,
        ) -> None: ...
...
class WorkerHeartbeatResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        health_status: global___WorkerHealth.ValueType = ...,
        worker_log: typing.Optional[typing.Iterable[global___Event]] = ...,
        hostname: typing.Text = ...,
        ) -> None: ...
