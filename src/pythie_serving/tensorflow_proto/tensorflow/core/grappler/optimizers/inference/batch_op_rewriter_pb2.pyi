...
class BatchOpRewriteConfig(google.protobuf.message.Message):
    ...
    class AdaptiveBatchSchedulerOption(google.protobuf.message.Message):
        ...
        * Latency sensitive
        ...
        def __init__(self,
            *,
            min_inflight_batches_limit: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
            initial_inflight_batches_limit: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
            max_inflight_batches_limit: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
            batches_to_average_over: typing.Optional[google.protobuf.wrappers_pb2.UInt32Value] = ...,
            ) -> None: ...
    ...
    class ModelSchedulerOptionsEntry(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            key: typing.Text = ...,
            value: typing.Optional[global___BatchOpRewriteConfig.AdaptiveBatchSchedulerOption] = ...,
            ) -> None: ...
    ...
    @property
    def model_scheduler_options(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___BatchOpRewriteConfig.AdaptiveBatchSchedulerOption]:
    ...
    def __init__(self,
        *,
        enable_adaptive_shared_batching_thread_pool: builtins.bool = ...,
        model_scheduler_options: typing.Optional[typing.Mapping[typing.Text, global___BatchOpRewriteConfig.AdaptiveBatchSchedulerOption]] = ...,
        ) -> None: ...
