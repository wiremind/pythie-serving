...
class KernelDef(google.protobuf.message.Message):
    ...
    @property
    def host_memory_arg(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        op: typing.Text = ...,
        device_type: typing.Text = ...,
        constraint: typing.Optional[typing.Iterable[global___KernelDef.AttrConstraint]] = ...,
        host_memory_arg: typing.Optional[typing.Iterable[typing.Text]] = ...,
        label: typing.Text = ...,
        priority: builtins.int = ...,
        ) -> None: ...
...
class KernelList(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        kernel: typing.Optional[typing.Iterable[global___KernelDef]] = ...,
        ) -> None: ...
