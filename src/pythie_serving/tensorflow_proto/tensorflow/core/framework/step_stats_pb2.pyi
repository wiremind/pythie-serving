...
class AllocatorMemoryUsed(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        peak_bytes: builtins.int = ...,
        live_bytes: builtins.int = ...,
        allocation_records: typing.Optional[typing.Iterable[global___AllocationRecord]] = ...,
        allocator_bytes_in_use: builtins.int = ...,
        ) -> None: ...
...
class NodeOutput(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        slot: builtins.int = ...,
        tensor_description: typing.Optional[tensorflow.core.framework.tensor_description_pb2.TensorDescription] = ...,
        ) -> None: ...
...
class MemoryStats(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        temp_memory_size: builtins.int = ...,
        persistent_memory_size: builtins.int = ...,
        persistent_tensor_alloc_ids: typing.Optional[typing.Iterable[builtins.int]] = ...,
        device_temp_memory_size: builtins.int = ...,
        device_persistent_memory_size: builtins.int = ...,
        device_persistent_tensor_alloc_ids: typing.Optional[typing.Iterable[builtins.int]] = ...,
        ) -> None: ...
...
class NodeExecStats(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        op_end_rel_micros: builtins.int = ...,
        all_end_rel_micros: builtins.int = ...,
        memory: typing.Optional[typing.Iterable[global___AllocatorMemoryUsed]] = ...,
        output: typing.Optional[typing.Iterable[global___NodeOutput]] = ...,
        timeline_label: typing.Text = ...,
        scheduled_micros: builtins.int = ...,
        thread_id: builtins.int = ...,
        referenced_tensor: typing.Optional[typing.Iterable[tensorflow.core.framework.allocation_description_pb2.AllocationDescription]] = ...,
        memory_stats: typing.Optional[global___MemoryStats] = ...,
        all_start_nanos: builtins.int = ...,
        op_start_rel_nanos: builtins.int = ...,
        op_end_rel_nanos: builtins.int = ...,
        all_end_rel_nanos: builtins.int = ...,
...
class DeviceStepStats(google.protobuf.message.Message):
    ...
    @property
    def thread_names(self) -> google.protobuf.internal.containers.ScalarMap[builtins.int, typing.Text]:
        """Its key is thread id."""
        pass
    def __init__(self,
        *,
        device: typing.Text = ...,
        node_stats: typing.Optional[typing.Iterable[global___NodeExecStats]] = ...,
        thread_names: typing.Optional[typing.Mapping[builtins.int, typing.Text]] = ...,
        ) -> None: ...
...
class StepStats(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        dev_stats: typing.Optional[typing.Iterable[global___DeviceStepStats]] = ...,
        ) -> None: ...
