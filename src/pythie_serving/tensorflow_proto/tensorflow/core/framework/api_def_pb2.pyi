...
class ApiDef(google.protobuf.message.Message):
    ...
    graph_op_name: typing.Text
    """Name of the op (in the OpDef) to specify the API for."""

    deprecation_message: typing.Text
    ...
    @property
    def arg_order(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    description_prefix: typing.Text
    """Modify an existing/inherited description by adding text to the beginning
    or end.
    """

    description_suffix: typing.Text
    def __init__(self,
        *,
        graph_op_name: typing.Text = ...,
        deprecation_message: typing.Text = ...,
        deprecation_version: builtins.int = ...,
        visibility: global___ApiDef.Visibility.ValueType = ...,
        endpoint: typing.Optional[typing.Iterable[global___ApiDef.Endpoint]] = ...,
        in_arg: typing.Optional[typing.Iterable[global___ApiDef.Arg]] = ...,
        out_arg: typing.Optional[typing.Iterable[global___ApiDef.Arg]] = ...,
        arg_order: typing.Optional[typing.Iterable[typing.Text]] = ...,
        attr: typing.Optional[typing.Iterable[global___ApiDef.Attr]] = ...,
        summary: typing.Text = ...,
        description: typing.Text = ...,
        description_prefix: typing.Text = ...,
        description_suffix: typing.Text = ...,
...
class ApiDefs(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        op: typing.Optional[typing.Iterable[global___ApiDef]] = ...,
        ) -> None: ...
