...
class _AutotuneAlgorithmEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AutotuneAlgorithm.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    HILL_CLIMB: _AutotuneAlgorithm.ValueType  # 0
    GRADIENT_DESCENT: _AutotuneAlgorithm.ValueType  # 1
...
HILL_CLIMB: AutotuneAlgorithm.ValueType  # 0
GRADIENT_DESCENT: AutotuneAlgorithm.ValueType  # 1
...
class ModelProto(google.protobuf.message.Message):
    ...
    class Node(google.protobuf.message.Message):
        ...
        @property
        def inputs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ModelProto.Node]:
            """Inputs of this node."""
            pass
        ...
        def __init__(self,
            *,
            ...
            processing_time: builtins.int = ...,
            record_metrics: builtins.bool = ...,
            parameters: typing.Optional[typing.Iterable[global___ModelProto.Node.Parameter]] = ...,
            input_processing_time_sum: builtins.float = ...,
            input_processing_time_count: builtins.int = ...,
            inputs: typing.Optional[typing.Iterable[global___ModelProto.Node]] = ...,
            node_class: global___NodeClass.ValueType = ...,
            ratio: builtins.float = ...,
            memory_ratio: builtins.float = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        output: typing.Optional[global___ModelProto.Node] = ...,
        id_counter: builtins.int = ...,
        collect_resource_usage: builtins.bool = ...,
        optimization_params: typing.Optional[global___ModelProto.OptimizationParams] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["optimization_params",b"optimization_params","output",b"output"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["collect_resource_usage",b"collect_resource_usage","id_counter",b"id_counter","optimization_params",b"optimization_params","output",b"output"]) -> None: ...
