...
class XSpace(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        planes: collections.abc.Iterable[global___XPlane] | None = ...,
...
class XPlane(google.protobuf.message.Message):
    ...
    class EventMetadataEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.int = ...,
            value: global___XEventMetadata | None = ...,
        ) -> None: ...
    ...
    class StatMetadataEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.int = ...,
            value: global___XStatMetadata | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value", b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key", b"key", "value", b"value"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        id: builtins.int = ...,
        name: builtins.str = ...,
        lines: collections.abc.Iterable[global___XLine] | None = ...,
        event_metadata: collections.abc.Mapping[builtins.int, global___XEventMetadata] | None = ...,
        stat_metadata: collections.abc.Mapping[builtins.int, global___XStatMetadata] | None = ...,
        stats: collections.abc.Iterable[global___XStat] | None = ...,
    ) -> None: ...
...
class XLine(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        timestamp_ns: builtins.int = ...,
        duration_ps: builtins.int = ...,
        events: collections.abc.Iterable[global___XEvent] | None = ...,
    ) -> None: ...
...
class XEvent(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data", b"data"]) -> typing_extensions.Literal["offset_ps", "num_occurrences"] | None: ...
...
class XStat(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["double_value", "uint64_value", "int64_value", "str_value", "bytes_value", "ref_value"] | None: ...
...
class XEventMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        metadata: builtins.bytes = ...,
        stats: collections.abc.Iterable[global___XStat] | None = ...,
        child_id: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
