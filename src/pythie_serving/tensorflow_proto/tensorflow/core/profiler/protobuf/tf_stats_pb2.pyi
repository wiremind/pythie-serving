...
class TfStatsDatabase(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        with_idle: global___TfStatsTable | None = ...,
        without_idle: global___TfStatsTable | None = ...,
        device_type: builtins.str = ...,
    ) -> None: ...
...
class TfStatsTable(google.protobuf.message.Message):
    ...
    host_tf_pprof_key: builtins.str
    """key to the pprof profile for host TF operations."""
    device_tf_pprof_key: builtins.str
    """key to the pprof profile for device TF operations."""
    def __init__(
        self,
        *,
        tf_stats_record: collections.abc.Iterable[global___TfStatsRecord] | None = ...,
        host_tf_pprof_key: builtins.str = ...,
        device_tf_pprof_key: builtins.str = ...,
    ) -> None: ...
