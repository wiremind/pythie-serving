...
class ProfilerService(object):
    ...
    def Profile(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tensorflow.ProfilerService/Profile',
    ...
    def Monitor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tensorflow.ProfilerService/Monitor',
