...
class CompressedComponentMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dtype",b"dtype","tensor_shape",b"tensor_shape","tensor_size_bytes",b"tensor_size_bytes"]) -> None: ...
...
class CompressedElement(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        data: builtins.bytes = ...,
        component_metadata: typing.Optional[typing.Iterable[global___CompressedComponentMetadata]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["component_metadata",b"component_metadata","data",b"data"]) -> None: ...
...
class UncompressedElement(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        components: typing.Optional[typing.Iterable[tensorflow.core.framework.tensor_pb2.TensorProto]] = ...,
        ) -> None: ...
