...
class GPUOptions(google.protobuf.message.Message):
    ...
    class Experimental(google.protobuf.message.Message):
        ...
        class VirtualDevices(google.protobuf.message.Message):
            ...
            def __init__(self,
                *,
                memory_limit_mb: typing.Optional[typing.Iterable[builtins.float]] = ...,
                priority: typing.Optional[typing.Iterable[builtins.int]] = ...,
                ) -> None: ...
            def ClearField(self, field_name: typing_extensions.Literal["memory_limit_mb",b"memory_limit_mb","priority",b"priority"]) -> None: ...
        ...
        collective_ring_order: typing.Text
        ...
        def __init__(self,
            *,
            virtual_devices: typing.Optional[typing.Iterable[global___GPUOptions.Experimental.VirtualDevices]] = ...,
            use_unified_memory: builtins.bool = ...,
            num_dev_to_dev_copy_streams: builtins.int = ...,
            collective_ring_order: typing.Text = ...,
            timestamped_allocator: builtins.bool = ...,
    ...
    visible_device_list: typing.Text
    ...
    def __init__(self,
        *,
        ...
        polling_inactive_delay_msecs: builtins.int = ...,
        force_gpu_compatible: builtins.bool = ...,
        experimental: typing.Optional[global___GPUOptions.Experimental] = ...,
        ) -> None: ...
...
class OptimizerOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["do_common_subexpression_elimination",b"do_common_subexpression_elimination","do_constant_folding",b"do_constant_folding","do_function_inlining",b"do_function_inlining","global_jit_level",b"global_jit_level","max_folded_constant_in_bytes",b"max_folded_constant_in_bytes","opt_level",b"opt_level"]) -> None: ...
...
class GraphOptions(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        enable_recv_scheduling: builtins.bool = ...,
        optimizer_options: typing.Optional[global___OptimizerOptions] = ...,
        build_cost_model: builtins.int = ...,
        build_cost_model_after: builtins.int = ...,
        infer_shapes: builtins.bool = ...,
        place_pruned_graph: builtins.bool = ...,
        enable_bfloat16_sendrecv: builtins.bool = ...,
        timeline_step: builtins.int = ...,
        rewrite_options: typing.Optional[tensorflow.core.protobuf.rewriter_config_pb2.RewriterConfig] = ...,
        ) -> None: ...
...
class RPCOptions(google.protobuf.message.Message):
    ...
    compression_algorithm: typing.Text
...
class ConfigProto(google.protobuf.message.Message):
    ...
    class Experimental(google.protobuf.message.Message):
        ...
        COORDINATION_SERVICE_FIELD_NUMBER: builtins.int
        FETCH_REMOTE_DEVICES_IN_MULTI_CLIENT_FIELD_NUMBER: builtins.int
        collective_group_leader: typing.Text
        """Task name for group resolution."""

        executor_type: typing.Text
        ...
        def __init__(self,
            *,
            ...
            disable_thread_spinning: builtins.bool = ...,
            share_cluster_devices_in_session: builtins.bool = ...,
            session_metadata: typing.Optional[global___SessionMetadata] = ...,
            optimize_for_static_graph: builtins.bool = ...,
            enable_mlir_bridge: builtins.bool = ...,
            mlir_bridge_rollout: global___ConfigProto.Experimental.MlirBridgeRollout.ValueType = ...,
            enable_mlir_graph_optimization: builtins.bool = ...,
        ...
        def ClearField(self, field_name: typing_extensions.Literal["collective_deterministic_sequential_execution",b"collective_deterministic_sequential_execution","collective_group_leader",b"collective_group_leader","collective_nccl",b"collective_nccl","coordination_service",b"coordination_service","disable_output_partition_graphs",b"disable_output_partition_graphs","disable_thread_spinning",b"disable_thread_spinning","enable_mlir_bridge",b"enable_mlir_bridge","enable_mlir_graph_optimization",b"enable_mlir_graph_optimization","executor_type",b"executor_type","fetch_remote_devices_in_multi_client",b"fetch_remote_devices_in_multi_client","mlir_bridge_rollout",b"mlir_bridge_rollout","optimize_for_static_graph",b"optimize_for_static_graph","recv_buf_max_chunk",b"recv_buf_max_chunk","session_metadata",b"session_metadata","share_cluster_devices_in_session",b"share_cluster_devices_in_session","share_session_state_in_clusterspec_propagation",b"share_session_state_in_clusterspec_propagation","use_numa_affinity",b"use_numa_affinity","use_tfrt",b"use_tfrt","xla_fusion_autotuner_thresh",b"xla_fusion_autotuner_thresh"]) -> None: ...
    ...
    EXPERIMENTAL_FIELD_NUMBER: builtins.int
    @property
    def device_count(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, builtins.int]:
    ...
    def __init__(self,
        *,
        device_count: typing.Optional[typing.Mapping[typing.Text, builtins.int]] = ...,
        intra_op_parallelism_threads: builtins.int = ...,
        inter_op_parallelism_threads: builtins.int = ...,
        use_per_session_threads: builtins.bool = ...,
        session_inter_op_thread_pool: typing.Optional[typing.Iterable[global___ThreadPoolOptionProto]] = ...,
        placement_period: builtins.int = ...,
        device_filters: typing.Optional[typing.Iterable[typing.Text]] = ...,
        gpu_options: typing.Optional[global___GPUOptions] = ...,
        allow_soft_placement: builtins.bool = ...,
        log_device_placement: builtins.bool = ...,
        graph_options: typing.Optional[global___GraphOptions] = ...,
        operation_timeout_in_ms: builtins.int = ...,
        rpc_options: typing.Optional[global___RPCOptions] = ...,
        cluster_def: typing.Optional[tensorflow.core.protobuf.cluster_pb2.ClusterDef] = ...,
        isolate_session_state: builtins.bool = ...,
        share_cluster_devices_in_session: builtins.bool = ...,
        experimental: typing.Optional[global___ConfigProto.Experimental] = ...,
        ) -> None: ...
...
class RunOptions(google.protobuf.message.Message):
    ...
    class Experimental(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            collective_graph_key: builtins.int = ...,
            use_run_handler_pool: builtins.bool = ...,
            run_handler_pool_options: typing.Optional[global___RunOptions.Experimental.RunHandlerPoolOptions] = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        report_tensor_allocations_upon_oom: builtins.bool = ...,
        experimental: typing.Optional[global___RunOptions.Experimental] = ...,
        ) -> None: ...
...
class RunMetadata(google.protobuf.message.Message):
    ...
    class FunctionGraphs(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            partition_graphs: typing.Optional[typing.Iterable[tensorflow.core.framework.graph_pb2.GraphDef]] = ...,
            pre_optimization_graph: typing.Optional[tensorflow.core.framework.graph_pb2.GraphDef] = ...,
            post_optimization_graph: typing.Optional[tensorflow.core.framework.graph_pb2.GraphDef] = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        partition_graphs: typing.Optional[typing.Iterable[tensorflow.core.framework.graph_pb2.GraphDef]] = ...,
        function_graphs: typing.Optional[typing.Iterable[global___RunMetadata.FunctionGraphs]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cost_graph",b"cost_graph","step_stats",b"step_stats"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cost_graph",b"cost_graph","function_graphs",b"function_graphs","partition_graphs",b"partition_graphs","step_stats",b"step_stats"]) -> None: ...
...
class TensorConnection(google.protobuf.message.Message):
    ...
    from_tensor: typing.Text
    """A tensor name. The value of this tensor will be substituted for
    the tensor named in `to_tensor`.
    """

    to_tensor: typing.Text
...
class CallableOptions(google.protobuf.message.Message):
    ...
    def tensor_connection(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TensorConnection]:
        ...
        pass
    @property
    def feed_devices(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, typing.Text]:
        ...
        pass
    @property
    def fetch_devices(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, typing.Text]: ...
    ...
    def __init__(self,
        *,
        ...
        run_options: typing.Optional[global___RunOptions] = ...,
        tensor_connection: typing.Optional[typing.Iterable[global___TensorConnection]] = ...,
        feed_devices: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        fetch_devices: typing.Optional[typing.Mapping[typing.Text, typing.Text]] = ...,
        fetch_skip_sync: builtins.bool = ...,
        ) -> None: ...
