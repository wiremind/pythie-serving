...
import tensorflow.core.protobuf.tpu.tpu_embedding_output_layout_pb2
import typing
...
class TPUEmbeddingConfiguration(google.protobuf.message.Message):
    ...
    class TableDescriptor(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            ...
            dimension: builtins.int = ...,
            num_features: builtins.int = ...,
            optimization_parameters: typing.Optional[tensorflow.core.protobuf.tpu.optimization_parameters_pb2.OptimizationParameters] = ...,
            ) -> None: ...
    ...
    profile_data_directory: typing.Text
    ...
    @property
    def output_layout(self) -> tensorflow.core.protobuf.tpu.tpu_embedding_output_layout_pb2.TPUEmbeddingOutputLayout:
        """Extended output layout information; deprecated and now ignored."""
        pass
    def __init__(self,
        *,
        table_descriptor: typing.Optional[typing.Iterable[global___TPUEmbeddingConfiguration.TableDescriptor]] = ...,
        mode: global___TPUEmbeddingConfiguration.Mode.ValueType = ...,
        batch_size_per_tensor_core: builtins.int = ...,
        num_hosts: builtins.int = ...,
        num_tensor_cores: builtins.int = ...,
        ...
        pipeline_execution_with_tensor_core: builtins.bool = ...,
        profile_data_directory: typing.Text = ...,
        output_layout: typing.Optional[tensorflow.core.protobuf.tpu.tpu_embedding_output_layout_pb2.TPUEmbeddingOutputLayout] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["output_layout",b"output_layout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["batch_size_per_tensor_core",b"batch_size_per_tensor_core","mode",b"mode","num_hosts",b"num_hosts","num_tensor_cores",b"num_tensor_cores","output_layout",b"output_layout","pipeline_execution_with_tensor_core",b"pipeline_execution_with_tensor_core","profile_data_directory",b"profile_data_directory","sharding_strategy",b"sharding_strategy","table_descriptor",b"table_descriptor"]) -> None: ...
