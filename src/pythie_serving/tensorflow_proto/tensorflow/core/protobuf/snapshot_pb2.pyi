...
class SnapshotMetadataRecord(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        creation_timestamp: builtins.int = ...,
        version: builtins.int = ...,
        dtype: typing.Optional[typing.Iterable[tensorflow.core.framework.types_pb2.DataType.ValueType]] = ...,
        num_elements: builtins.int = ...,
        finalized: builtins.bool = ...,
        ) -> None: ...
...
class SnapshotTensorMetadata(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        tensor_metadata: typing.Optional[typing.Iterable[global___TensorMetadata]] = ...,
        ) -> None: ...
