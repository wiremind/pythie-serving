...
class DebugTensorWatch(google.protobuf.message.Message):
    ...
    @property
    def debug_ops(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        ...
        pass
    @property
    def debug_urls(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        node_name: typing.Text = ...,
        output_slot: builtins.int = ...,
        debug_ops: typing.Optional[typing.Iterable[typing.Text]] = ...,
        debug_urls: typing.Optional[typing.Iterable[typing.Text]] = ...,
        tolerate_debug_op_creation_failures: builtins.bool = ...,
        ) -> None: ...
...
class DebugOptions(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        debug_tensor_watch_opts: typing.Optional[typing.Iterable[global___DebugTensorWatch]] = ...,
        global_step: builtins.int = ...,
        reset_disk_byte_usage: builtins.bool = ...,
        ) -> None: ...
...
class DebuggedSourceFiles(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        source_files: typing.Optional[typing.Iterable[global___DebuggedSourceFile]] = ...,
        ) -> None: ...
