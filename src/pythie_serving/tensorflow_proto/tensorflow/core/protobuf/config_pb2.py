...
from pythie_serving.tensorflow_proto.tensorflow.core.protobuf import coordination_config_pb2 as tensorflow_dot_core_dot_protobuf_dot_coordination__config__pb2
