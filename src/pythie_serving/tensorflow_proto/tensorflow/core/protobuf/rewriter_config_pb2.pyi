...
class ScopedAllocatorOptions(google.protobuf.message.Message):
    ...
    @property
    def enable_op(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        """If present, only perform optimization for these ops."""
        pass
    def __init__(self,
        *,
        enable_op: typing.Optional[typing.Iterable[typing.Text]] = ...,
        ) -> None: ...
...
class RewriterConfig(google.protobuf.message.Message):
    ...
    class CustomGraphOptimizer(google.protobuf.message.Message):
        ...
        name: typing.Text
        @property
        def parameter_map(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, tensorflow.core.framework.attr_value_pb2.AttrValue]: ...
        def __init__(self,
            *,
            name: typing.Text = ...,
            parameter_map: typing.Optional[typing.Mapping[typing.Text, tensorflow.core.framework.attr_value_pb2.AttrValue]] = ...,
            ) -> None: ...
    ...
    memory_optimizer_target_node_name_scope: typing.Text
    ...
    @property
    def optimizers(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
    ...
    def __init__(self,
        *,
        ...
        memory_optimizer_target_node_name_scope: typing.Text = ...,
        meta_optimizer_timeout_ms: builtins.int = ...,
        auto_parallel: typing.Optional[global___AutoParallelOptions] = ...,
        fail_on_optimizer_errors: builtins.bool = ...,
        scoped_allocator_opts: typing.Optional[global___ScopedAllocatorOptions] = ...,
        optimizers: typing.Optional[typing.Iterable[typing.Text]] = ...,
        custom_optimizers: typing.Optional[typing.Iterable[global___RewriterConfig.CustomGraphOptimizer]] = ...,
        inter_optimizer_verifier_config: typing.Optional[tensorflow.core.protobuf.verifier_config_pb2.VerifierConfig] = ...,
        post_optimization_verifier_config: typing.Optional[tensorflow.core.protobuf.verifier_config_pb2.VerifierConfig] = ...,
        ) -> None: ...
