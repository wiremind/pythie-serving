...
from pythie_serving.tensorflow_proto.tensorflow.contrib.rpc.python.kernel_tests import test_example_pb2 as tensorflow_dot_contrib_dot_rpc_dot_python_dot_kernel__tests_dot_test__example__pb2
