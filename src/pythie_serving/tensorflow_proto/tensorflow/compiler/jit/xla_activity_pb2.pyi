...
class XlaAutoClusteringSummary(google.protobuf.message.Message):
    ...
    class Cluster(google.protobuf.message.Message):
        ...
        def __init__(self,
            *,
            name: typing.Text = ...,
            size: builtins.int = ...,
            op_histogram: typing.Optional[typing.Iterable[global___XlaAutoClusteringSummary.OpAndCount]] = ...,
            ) -> None: ...
    ...
    def __init__(self,
        *,
        unclustered_node_count: builtins.int = ...,
        clustered_node_count: builtins.int = ...,
        clusters: typing.Optional[typing.Iterable[global___XlaAutoClusteringSummary.Cluster]] = ...,
        unclustered_op_histogram: typing.Optional[typing.Iterable[global___XlaAutoClusteringSummary.OpAndCount]] = ...,
        ) -> None: ...
...
class XlaAutoClusteringActivity(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        global_jit_level: tensorflow.core.protobuf.config_pb2.OptimizerOptions.GlobalJitLevel.ValueType = ...,
        cpu_global_jit_enabled: builtins.bool = ...,
        summary: typing.Optional[global___XlaAutoClusteringSummary] = ...,
        ) -> None: ...
...
class XlaJitCompilationActivity(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_name",b"cluster_name","compile_count",b"compile_count","compile_time_us",b"compile_time_us","cumulative_compile_time_us",b"cumulative_compile_time_us"]) -> None: ...
...
class XlaOptimizationRemark(google.protobuf.message.Message):
    ...
    class _WarningEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[XlaOptimizationRemark._Warning.ValueType], builtins.type):
